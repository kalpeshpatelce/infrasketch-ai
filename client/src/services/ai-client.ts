...
export const LLM_PROVIDERS: LLMProvider[] = [
  {
    id: "github",
    name: "GitHub Models (Recommended)",
    models: ["gpt-4.1", "gpt-4o", "gpt-4.1-mini", "gpt-4o-mini", "DeepSeek-R1", "DeepSeek-R1-0528", "DeepSeek-V3-0324", "Llama-3.3-70B-Instruct", "Phi-4"],
    defaultModel: "gpt-4.1",
    baseUrl: "https://models.inference.ai.azure.com/chat/completions",
    authHeader: (token) => ({ Authorization: `Bearer ${token}` }),
    docUrl: "https://github.com/settings/tokens",
    tokenNote: "Create a Fine-grained PAT with 'models:read' permission. Free to use.",
  },
  {
    id: "openai",
    name: "OpenAI",
    ...
    tokenNote: "Create an API key at platform.openai.com. Paid usage.",
  },
  {
    id: "anthropic",
    ...
    tokenNote: "Create API key at console.anthropic.com. Paid usage.",
  },
  {
    id: "groq",
    name: "Groq (Fast & Free)",
    ...
    tokenNote: "Free tier available with generous limits. Very fast inference.",
  },
  {
    id: "together",
    name: "Together AI",
    ...
    tokenNote: "$25 free credits on signup. 200+ open-source models.",
  },
  {
    id: "openrouter",
    ...
    tokenNote: "Aggregator for 200+ models. Free credits available on signup.",
  },
  {
    id: "mistral",
    name: "Mistral AI",
    ...
    tokenNote: "European AI provider. Free tier available for small models.",
  },
  {
    id: "deepseek",
    name: "DeepSeek",
    ...
    tokenNote: "Very affordable pricing. Strong coding performance.",
  },
  {
    id: "fireworks",
    name: "Fireworks AI",
    ...
    tokenNote: "Fast inference. Free tier with $1 credits on signup.",
  },
  {
    id: "perplexity",
    name: "Perplexity",
    ...
    tokenNote: "AI with real-time web search built in. Paid API.",
  },
  {
    id: "cohere",
    name: "Cohere",
    ...
    tokenNote: "Free trial API key available. Enterprise-focused.",
  },
  {
    id: "nvidia",
    name: "NVIDIA NIM",
    ...
    tokenNote: "1000 free API calls. GPU-optimized inference.",
  },
];
